# Manual Setup Steps for Minions Ideator
...
Go to **GitHub → mxn2020/minions-ideator → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-ideator` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-ideator-web`
- **GitHub repo**: `mxn2020/minions-ideator`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `ideator.minions.wtf`

### Documentation
- **Netlify site name**: `minions-ideator-docs`
- **GitHub repo**: `mxn2020/minions-ideator`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `ideator.minions.help`

### Blog
- **Netlify site name**: `minions-ideator-blog`
- **GitHub repo**: `mxn2020/minions-ideator`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `ideator.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `ideator.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `ideator.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `ideator.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-ideator/sdk`](https://www.npmjs.com/package/@minions-ideator/sdk)
- CLI: [`@minions-ideator/cli`](https://www.npmjs.com/package/@minions-ideator/cli)
...
Your package: [`minions-ideator`](https://pypi.org/project/minions-ideator/)
...
| Item | Value |
|------|-------|
| Project | `minions-ideator` |
| SDK (npm) | `@minions-ideator/sdk` |
| CLI (npm) | `@minions-ideator/cli` |
| Python (PyPI) | `minions-ideator` |
| GitHub | `github.com/mxn2020/minions-ideator` |
| Docs domain | `ideator.minions.help` |
| Blog domain | `ideator.minions.blog` |
| App domain | `ideator.minions.wtf` |

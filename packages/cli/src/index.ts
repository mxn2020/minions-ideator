...
/**
 * @minions-ideator/cli — CLI for Minions Ideator
 *
...
import { customTypes } from '@minions-ideator/sdk';
...
program
    .name('ideator')
    .description('Agent to help brainstorm ideas and plan features')
    .version('0.1.0');
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Ideator'));
        console.log(chalk.dim('Agent to help brainstorm ideas and plan features'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-ideator/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-ideator/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-ideator')}`);
